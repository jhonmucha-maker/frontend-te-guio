...
const TARGET_INFO = {
  ...
  'approval.seller.approved':      { label: 'Vendedor solicitante',     color: 'bg-blue-50 text-blue-700 border-blue-200/60' },
  'approval.seller.rejected':      { label: 'Vendedor solicitante',     color: 'bg-blue-50 text-blue-700 border-blue-200/60' },
  ...
  'admin.pending.seller':          { label: 'Todos los administradores', color: 'bg-purple-50 text-purple-700 border-purple-200/60' },
